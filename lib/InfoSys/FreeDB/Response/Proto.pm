...
sub new_from_content_ref {
    ...
    $code == 200 || $code == 201 || $code == 501 || $code == 502 ||
        throw Error::Simple ('ERROR: InfoSys::FreeDB::Response::Proto::new_from_content_ref, first line of specified \'content_ref\' does not contain a valid code.');
    my %opt;
    ...
    if ($code == 200) {
        ...
        throw Error::Simple ("ERROR: InfoSys::FreeDB::Response::Proto::new_from_content_ref, unknown code '$code' returned.");
    }
